...
According to gemini, if u half the number of turns in a trasnformer, then the inductance is 1/4, since inductance is proportional to the square of the number of turns.

THis means that to model the center tapped transformer, the inductance of each half is 80 uH/4 = 20 uH. That solves the issue!
